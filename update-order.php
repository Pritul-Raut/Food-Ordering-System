            ...
            <form action="" method="POST">
                ...
                <div class="deleivery-details">
                    ...
                    <div class="data-input">
                        ...
                        <input type="text" name="full-name" placeholder="Enter the name" value="<?php echo $name; ?>"
                            required>
                    </div>
                    ...
                    <div class="data-input">
                        <label>Phone</label>
                        <input type="tel" name="contact" placeholder="Enter the phone" value="<?php echo $phone; ?>"
                            required>
                    </div>

                    <div class="data-input">
                        <label>Address</label>
                        <textarea name="address" id="" cols="30" rows="10" placeholder="Message"
