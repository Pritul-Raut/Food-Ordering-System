    ...
    <div class="form">
        <form action="#" method="post" enctype="multipart/form-data">
            ...
            <div class="data-input normal-word-space">
                ...
                <input type="text" placeholder="Enter the title" name="title" id="title" value="<?php echo $title; ?>"
                    required>
            </div>
            ...
            <div class="data-input normal-word-space">
                ...
                <input type="text" placeholder="Enter the price" name="price" id="price" value="<?php echo $price; ?>"
                    required>
        ...
        if (isset($_FILES['image']['name'])) {
            ...
            if ($imagename != "") {
                ...
                if (!$upload) {
                    ...
                    echo "<script>window.location.href='adminPanel/manage-food.php'</script>";
                    // header('location:' . INDEXPAGE . 'adminPanel/manage-food.php');
                    die();
                }
